% COMP3028 Coursework 1 – Task 1: Frequency Analysis Report
% Build from docs/reports/task1/: pdflatex report_task1 && bibtex report_task1 && pdflatex report_task1 && pdflatex report_task1
% Optional: put build artifacts in build/ with pdflatex -output-directory=build report_task1 (then bibtex build/report_task1, etc.)
...
\usepackage{url}
\usepackage{seqsplit}
% Allow long path/script names to break within margins (avoid overfull hboxes)
...
\title{\textbf{Task 1: Frequency Analysis}\\[0.5em]
\large COMP3028 Computer Security --- Coursework 1}
